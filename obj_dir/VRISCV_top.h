...
class VRISCV_top VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit VRISCV_top(VerilatedContext* contextp, const char* name = "TOP");
    explicit VRISCV_top(const char* name = "TOP");
